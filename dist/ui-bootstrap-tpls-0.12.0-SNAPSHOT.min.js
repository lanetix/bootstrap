 ...
 * Version: 0.12.0-SNAPSHOT - 2014-05-29
 * License: MIT
 */
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html", "template/accordion/accordion.html", "template/alert/alert.html", "template/carousel/carousel.html", "template/carousel/slide.html", "template/datepicker/datepicker.html", "template/datepicker/day.html", "template/datepicker/month.html", "template/datepicker/popup.html", "template/datepicker/year.html", "template/modal/backdrop.html", "template/modal/window.html", "template/pagination/pager.html", "template/pagination/pagination.html", "template/tooltip/tooltip-html-unsafe-popup.html", "template/tooltip/tooltip-popup.html", "template/popover/popover.html", "template/progressbar/bar.html", "template/progressbar/progress.html", "template/progressbar/progressbar.html", "template/rating/rating.html", "template/tabs/tab.html", "template/tabs/tabset.html", "template/timepicker/timepicker.html", "template/typeahead/typeahead-match.html", "template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function (a, b, c) {
  ...
  var a = {options: {backdrop: !0, keyboard: !0}, $get: ["$injector", "$rootScope", "$q", "$http", "$templateCache", "$controller", "$modalStack", function (b, c, d, e, f, g, h) {
    ...
    return k.open = function (b) {
      ...
      return l.then(function (a) {
        ...
        var f = {}, i = 1;
        b.controller && (f.$scope = d, f.$modalInstance = k, angular.forEach(b.resolve, function (b, c) {
          f[c] = a[i++]
        }), g(b.controller, f)), h.open(k, {scope: d, deferred: e, content: a[0], backdrop: b.backdrop, keyboard: b.keyboard, backdropClass: b.backdropClass, windowClass: b.windowClass, windowTemplateUrl: b.windowTemplateUrl, size: b.size})
      }, function (a) {
        e.reject(a)
      }), l.then(function () {
        f.resolve(!0)
  ...
  function h() {
    ...
    return b >= 0 && 60 > b ? 10 > b ? "0" + b : b : void 0
  }
  ...
  return{require: "ngModel", link: function (i, j, k, l) {
    var m = i.$eval(k.typeaheadMinLength);
    m = 0 === m ? m : m || 1;
    var n, o = i.$eval(k.typeaheadWaitMs) || 0, p = i.$eval(k.typeaheadEditable) !== !1, q = b(k.typeaheadLoading).assign || angular.noop, r = b(k.typeaheadOnSelect), s = k.typeaheadInputFormatter ? b(k.typeaheadInputFormatter) : void 0, t = k.typeaheadAppendToBody ? i.$eval(k.typeaheadAppendToBody) : !1, u = i.$eval(k.typeaheadFocusAfterSelect) !== !1, v = i.$eval(k.typeaheadPopupLeftOffset) || 0, w = b(k.ngModel).assign, x = g.parse(k.typeahead), y = i.$new();
    i.$on("$destroy", function () {
      y.$destroy()
    });
    var z = "typeahead-" + y.$id + "-" + Math.floor(1e4 * Math.random());
    j.attr({"aria-autocomplete": "list", "aria-expanded": !1, "aria-owns": z});
    var A = angular.element("<div typeahead-popup></div>");
    A.attr({id: z, matches: "matches", active: "activeIdx", select: "select(activeIdx)", query: "query", position: "position"}), angular.isDefined(k.typeaheadTemplateUrl) && A.attr("template-url", k.typeaheadTemplateUrl);
    var B = function () {
      y.matches = [], y.activeIdx = -1, j.attr("aria-expanded", !1)
    }, C = function (a) {
      return z + "-option-" + a
    };
    y.$watch("activeIdx", function (a) {
      0 > a ? j.removeAttr("aria-activedescendant") : j.attr("aria-activedescendant", C(a))
    });
    var D = function (a) {
      var b = {$viewValue: a};
      q(i, !0), c.when(x.source(i, b)).then(function (c) {
        var d = a === l.$viewValue;
        if (d && n)if (c.length > 0) {
          y.activeIdx = 0, y.matches.length = 0;
          for (var e = 0; e < c.length; e++)b[x.itemName] = c[e], y.matches.push({id: C(e), label: x.viewMapper(y, b), model: c[e]});
          y.query = a, y.position = t ? f.offset(j) : f.position(j), y.position.top = y.position.top + j.prop("offsetHeight"), y.position.left = y.position.left + v, j.attr("aria-expanded", !0)
        } else B();
        d && q(i, !1)
      }, function () {
        B(), q(i, !1)
    ...
    0 === m && j.bind("focus", function () {
      n = !0, D(l.$viewValue)
    }), l.$parsers.unshift(function (a) {
      return n = !0, 0 === m || a && a.length >= m ? o > 0 ? (G(), F(a)) : D(a) : (q(i, !1), G(), B()), p ? a : a ? void l.$setValidity("editable", !1) : (l.$setValidity("editable", !0), a)
    }), l.$formatters.push(function (a) {
      var b, c, d = {};
      return s ? (d.$model = a, s(i, d)) : (d[x.itemName] = a, b = x.viewMapper(i, d), d[x.itemName] = void 0, c = x.viewMapper(i, d), b !== c ? b : a)
    }), y.select = function (a) {
      var b, c, e = {};
      e[x.itemName] = c = y.matches[a].model, b = x.modelMapper(i, e), w(i, b), l.$setValidity("editable", !0), r(i, {$item: c, $model: b, $label: x.viewMapper(i, e)}), B(), u && d(function () {
        j[0].focus()
      }, 0, !1)
    }, j.bind("keydown", function (a) {
      if (0 !== y.matches.length && -1 !== h.indexOf(a.which)) {
        a.preventDefault();
        var b;
        if (40 === a.which) {
          for (b = 0; b < y.matches.length && (y.activeIdx = (y.activeIdx + 1) % y.matches.length, y.matches[y.activeIdx].model.notSelectable); b++);
          y.$digest()
        } else if (38 === a.which) {
          for (b = 0; b < y.matches.length && (y.activeIdx = (y.activeIdx ? y.activeIdx : y.matches.length) - 1, y.matches[y.activeIdx].model.notSelectable); b++);
          y.$digest()
        } else 13 === a.which || 9 === a.which ? (y.$apply(function () {
          y.select(y.activeIdx)
        }), u || d(function () {
          j[0].blur()
        }, 0, !1)) : 27 === a.which && (a.stopPropagation(), B(), y.$digest())
      }
    }), j.bind("blur", function () {
      n = !1
    });
    var H = function (a) {
      j[0] !== a.target && (B(), y.$digest())
    };
    e.bind("click", H), i.$on("$destroy", function () {
      e.unbind("click", H)
    });
    var I = a(A)(y);
    t ? e.find("body").append(I) : j.after(I)
  }}
