...
angular.module('lx.ui.bootstrap.demo', ['lx.ui.bootstrap', 'plunker', 'ngTouch'], function($httpProvider){
...
var SelectModulesCtrl = function($scope, $modalInstance, modules, buildFilesService) {
  ...
  $scope.build = function (selectedModules, version) {
    ...
    function createNoTplFile(srcModuleNames, srcJsContent) {
      return 'angular.module("lx.ui.bootstrap", [' + srcModuleNames.join(',') + ']);\n' +
        srcJsContent;
    }
    ...
    function createWithTplFile(srcModuleNames, srcJsContent, tplModuleNames, tplJsContent) {
      ...
      depModuleNames.unshift('"lx.ui.bootstrap.tpls"');

      return 'angular.module("lx.ui.bootstrap", [' + depModuleNames.join(',') + ']);\n' +
        'angular.module("lx.ui.bootstrap.tpls", [' + tplModuleNames.join(',') + ']);\n' +
        srcJsContent + '\n' + tplJsContent;
